CREATE TABLE  rides(tripid integer,faremethod integer,fare integer,loc_from integer,loc_to integer,driverid integer,custid integer,distance integer,duration integer); 

INSERT INTO rides(tripid,faremethod,fare,loc_from,loc_to,driverid,custid,distance,duration) 
 values
